...
import 'package:hotel_app/controller/c_history.dart';
...
class _HistoryPageState extends State<HistoryPage> {
  final controllerHistory = Get.put(CHistory());
  final controllerUser = Get.put(CUser());

  @override
  void initState() {
    controllerHistory.getListHistory(controllerUser.data.id!);
    super.initState();
  }
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Obx(() {
                return Text(
                  '${controllerHistory.listHistory.length} Transaction',
                  style: TextStyle(
                    color: Colors.grey,
                    fontSize: 12,
                  ),
